...
class User implements UserInterface
{
    ...
    public function getDeezerApiKey(): ?string
    {
        return $this->deezer_api_key;
    }

    public function setDeezerApiKey(?string $deezer_api_key): self
    {
        $this->deezer_api_key = $deezer_api_key;
